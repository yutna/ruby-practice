...
class TestWordPlay < Minitest::Test
  def test_sentences
    ...
    test_text =
      "Hello. This is a test of sentence separation. This is the end of the test."
  ...
  def test_sentence_choice
    assert_equal(
      ...
      WordPlay.best_sentence(
        ["This is a test", "This is another test", "This is a great test"],
        %w[test great this]
      )
    )
  ...
  def test_mixed_pronouns
    ...
    assert_equal(
      "i annoy your dog",
      WordPlay.switch_pronouns("you annoy my dog")
    )
  end
end
